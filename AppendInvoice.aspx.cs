...
namespace EasyCartAdmin.TestCode
{
    public partial class AppendInvoice : System.Web.UI.Page
    {
        ...
        private List<wsInvoiceService.OrderImporterParm> GetData() 
        {
            ...
            item1.OrderID = "B20150519002";//訂單號碼
            item1.OrderDate = Convert.ToDateTime("2015-05-14");//訂單日期
            item1.InvoiceFor = "C";//發票類型
            item1.BuyerName = "";//買受人名稱
            item1.BuyerInvoiceTitle = "";//買受人發票抬頭
            item1.BuyerCompanyId = "";//買受人統編
            item1.BuyerEmail = "service@systemlead.com.tw";//客戶電子郵件
            item1.BuyerCellPhone = "";//客戶行動電話
            item1.Amount = 3000;//訂單總額(未稅)
            item1.TaxType = "1";//課稅類別
            item1.Tax = 150;//發票稅額
            item1.TotalAmount = 3150;//含稅總額
            item1.ProductID = "";//產品代號
            item1.ProductName = "BENZ-W204-4D/前檔/副/台/膠";//產品名稱
            item1.Quantity = 1;//購買數量
            item1.UnitPrice = 2625;//產品單價
